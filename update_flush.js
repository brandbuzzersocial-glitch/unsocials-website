...
const replacement = `<section id="ai-results" style="padding:100px 0 100px max(6vw, calc(50vw - 650px)); background:#060606; overflow:hidden; position:relative; z-index:10; min-height:100svh; display:flex; align-items:center; width:100%;">
...
html = html.replace(/<section id="ai-results"[\s\S]*?<\/section>/, replacement);
